...
describe('DependencyContainer', () => {
    ...
    const mockEnvironment = require('../../../../../shared/infrastructure/config/Environment').Environment;
    // テスト用のロガー参照を取得
    const mockLogger = require('../../../../../shared/infrastructure/logging/Logger').logger;
